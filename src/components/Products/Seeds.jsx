...
const Seeds = () => {
    ...
    const fetchPlants = async () => {
        try {
            ...
            if (response.data.success) {
                const filteredPlants = response.data.data.pageData.filter(plant => plant.categoryName === "seeds");
                setSeedsList(filteredPlants);
    ...
    useEffect(() => {
        fetchPlants(); // Gọi API để lấy toàn bộ danh sách Seeds
    }, [debouncedSearchTerm]);
    ...
    const getPaginatedItems = () => {
        ...
        return SeedsList.slice(startIndex, endIndex); // Lấy sản phẩm theo trang
    };
