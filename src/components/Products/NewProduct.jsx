...
const NewProduct = () => {
    ...
    const fetchPlants = async () => {
        try {
            ...
            if (response.data.success) {
                const filteredPlants = response.data.data.pageData.filter(plant => plant.categoryName === "newproduct");
                setNewProductList(filteredPlants);
    ...
    useEffect(() => {
        fetchPlants(); // Gọi API để lấy toàn bộ danh sách NewProduct
    }, [debouncedSearchTerm]);
    ...
    const getPaginatedItems = () => {
        ...
        return NewProductList.slice(startIndex, endIndex); // Lấy sản phẩm theo trang
    };
