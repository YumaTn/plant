...
const Cactus = () => {
    ...
    const fetchPlants = async () => {
        try {
            ...
            if (response.data.success) {
                const filteredPlants = response.data.data.pageData.filter(plant => plant.categoryName === "cactus");
                setCactusList(filteredPlants);
    ...
    useEffect(() => {
        fetchPlants(); // Gọi API để lấy toàn bộ danh sách Cactus
    }, [debouncedSearchTerm]);
    ...
    const getPaginatedItems = () => {
        ...
        return CactusList.slice(startIndex, endIndex); // Lấy sản phẩm theo trang
    };
