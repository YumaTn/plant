...
const AllProduct = () => {
    ...
    const fetchPlants = async () => {
        try {
            ...
            if (response.data.success) {
                ...
                setTotalItems(response.data.data.pageData.length); // Cập nhật tổng số sản phẩm
            }
        } catch (error) {
    ...
    useEffect(() => {
        fetchPlants(); // Gọi API để lấy toàn bộ danh sách AllProduct
    }, [debouncedSearchTerm]);
    ...
    const getPaginatedItems = () => {
        ...
        return AllProductList.slice(startIndex, endIndex); // Lấy sản phẩm theo trang
    };
