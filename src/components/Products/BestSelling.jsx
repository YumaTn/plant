...
const BestSelling = () => {
    ...
    const fetchPlants = async () => {
        try {
            ...
            if (response.data.success) {
                const filteredPlants = response.data.data.pageData.filter(plant => plant.categoryName === "bestSelling");
                setBestSellingList(filteredPlants);
    ...
    useEffect(() => {
        fetchPlants(); // Gọi API để lấy toàn bộ danh sách BestSelling
    }, [debouncedSearchTerm]);
    ...
    const getPaginatedItems = () => {
        ...
        return BestSellingList.slice(startIndex, endIndex); // Lấy sản phẩm theo trang
    };
