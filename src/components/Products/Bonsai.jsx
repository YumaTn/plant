...
const Bonsai = () => {
    ...
    const fetchPlants = async () => {
        try {
            ...
            if (response.data.success) {
                const filteredPlants = response.data.data.pageData.filter(plant => plant.categoryName === "bonsai");
                setBonsaiList(filteredPlants);
    ...
    useEffect(() => {
        fetchPlants(); // Gọi API để lấy toàn bộ danh sách bonsai
    }, [debouncedSearchTerm]);
    ...
    const getPaginatedItems = () => {
        ...
        return bonsaiList.slice(startIndex, endIndex); // Lấy sản phẩm theo trang
    };
